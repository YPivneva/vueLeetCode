      ...
      computed: {
        filteredTasks() {
          return this.tasks.filter(task => {
            const matchesDifficulty = this.filters.difficulty ? task.difficulty === this.filters.difficulty : true;
            const matchesCategory = this.filters.category ? task.category === this.filters.category : true;
